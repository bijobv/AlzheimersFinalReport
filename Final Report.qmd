...
There are **`r nrow(alzdata)`** observations and **`r ncol(alzdata)`** variables in this dataset, of which **`r (ncol(alzdata)-1)`** are independent variables and **'1'** is the target variable. The table below provides a breakdown of these variables.
