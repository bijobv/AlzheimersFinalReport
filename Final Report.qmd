...
```{r CPE2, echo=FALSE, warning=FALSE, message=FALSE}
...
##### Figure 5. Model performance across all probability thresholds, using ROC

```{r CPE3, echo=FALSE, warning=FALSE, message=FALSE}
